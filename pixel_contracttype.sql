...
CREATE TABLE `contracttype` (
  `contract_typeid` bigint NOT NULL AUTO_INCREMENT,
  ...
  KEY `createdBy_contractType_idx` (`created_by`),
  KEY `updatedBy_contractType_idx` (`updated_by`)
...
INSERT INTO `contracttype` VALUES (1,'خدمات إعلامية ',1,'2024-03-07 10:38:17',NULL,NULL),(2,'خدمات موقع',1,'2024-03-07 10:38:17',NULL,NULL);
