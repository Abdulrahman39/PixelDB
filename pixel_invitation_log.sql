...
CREATE TABLE `invitation_log` (
  `invitation_logID` bigint NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`invitation_logID`),
  KEY `createdBy_invitationLog_idx` (`created_by`),
  KEY `updatedBy_invitationLog_idx` (`updated_by`),
  KEY `invitee_invitationLog_idx` (`invitee`),
  KEY `eventID_invitationLog_idx` (`eventID`),
  KEY `invitationID_invitationLog_idx` (`invitationID`),
  KEY `deletedBy_invitation_log` (`deletedBy`)
