...
CREATE TABLE `action_log` (
  ...
  `deletedAt` datetime(1) DEFAULT NULL,
  PRIMARY KEY (`action_logID`),
  KEY `actionID_actionLog_idx` (`actionID`),
  KEY `processID_actionLog_idx` (`processID`),
  KEY `actionType_actionLog_idx` (`actionTypeID`),
  KEY `createdBy_actionLog_idx` (`created_by`),
  KEY `updatedBy_actionLog_idx` (`updated_by`),
  KEY `deletedBy_action_log` (`deletedBy`)
