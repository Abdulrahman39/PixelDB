...
DROP TABLE IF EXISTS `invoiceterms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `invoiceterms` (
  `invoiceTermsID` bigint NOT NULL AUTO_INCREMENT,
  ...
  KEY `updatedBy_invoiceTemrs_idx` (`updated_by`),
  KEY `invoiceID_invoiceTemrs_idx` (`invoiceID`),
...
LOCK TABLES `invoiceterms` WRITE;
/*!40000 ALTER TABLE `invoiceterms` DISABLE KEYS */;
/*!40000 ALTER TABLE `invoiceterms` ENABLE KEYS */;
UNLOCK TABLES;
