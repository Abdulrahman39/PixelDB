...
CREATE TABLE `platform_log` (
  `platform_logID` bigint NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`platform_logID`),
  KEY `createdBy_platform_idx` (`created_by`),
  KEY `updatedBy_platform_idx` (`updated_by`),
  KEY `platformID_platform_idx` (`platformID`),
  KEY `deletedBy_platform_log` (`deletedBy`)
