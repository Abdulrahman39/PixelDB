...
CREATE TABLE `projectstatus` (
  ...
  KEY `createdBy_projectstatus_idx` (`created_by`),
  KEY `updatedBy_projectstatus_idx` (`updated_by`)
...
INSERT INTO `projectstatus` VALUES (1,'مفتوح',1,'2024-03-07 10:38:17',NULL,NULL),(2,'مغلق',1,'2024-03-07 10:38:17',NULL,NULL);
