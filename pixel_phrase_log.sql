...
CREATE TABLE `phrase_log` (
  ...
  PRIMARY KEY (`phrase_logID`),
  KEY `createdBy_phraseLog_idx` (`created_by`),
  KEY `updatedBy_phraseLog_idx` (`updated_by`),
  KEY `phraseID_phraseLog_idx` (`phraseID`),
  KEY `deletedBy_phrase_log` (`deletedBy`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `phrase_log`
--

LOCK TABLES `phrase_log` WRITE;
