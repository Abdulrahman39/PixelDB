...
CREATE TABLE `dependancy` (
  `dependancyID` bigint NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`dependancyID`),
  KEY `taskID_depend_idx` (`taskID`),
  KEY `dependID_depend_idx` (`dependsOn`),
  KEY `createdBy_depend_idx` (`created_by`),
  KEY `updatedBy_depend_idx` (`updated_by`)
