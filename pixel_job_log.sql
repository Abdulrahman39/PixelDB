...
CREATE TABLE `job_log` (
  `job_logID` bigint NOT NULL AUTO_INCREMENT,
  ...
  KEY `jobID_jobLog_idx` (`jobID`),
  KEY `createdBy_jobLog_idx` (`created_by`),
  KEY `updatedBy_jobLog_idx` (`updated_by`),
  KEY `deletedBy_job_log` (`deletedBy`)
