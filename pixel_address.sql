...
CREATE TABLE `address` (
  ...
  KEY `governate_idx` (`governateID`),
  KEY `block_idx` (`blockID`),
  KEY `district_idx` (`districtID`),
  KEY `bldgtype_idx` (`unitTypeID`),
  KEY `create_idx` (`created_by`),
  KEY `update_idx` (`updated_by`)
