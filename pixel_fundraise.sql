...
CREATE TABLE `fundraise` (
  `fundraisedesignID` bigint NOT NULL AUTO_INCREMENT,
  `date` date DEFAULT NULL,
  `marketing_taskid` bigint DEFAULT NULL,
...
LOCK TABLES `fundraise` WRITE;
/*!40000 ALTER TABLE `fundraise` DISABLE KEYS */;
/*!40000 ALTER TABLE `fundraise` ENABLE KEYS */;
UNLOCK TABLES;
