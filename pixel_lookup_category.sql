...
CREATE TABLE `lookup_category` (
  ...
  PRIMARY KEY (`lookup_categoryID`),
  KEY `createdBy_lookupcategory_idx` (`created_by`),
  KEY `updatedBy_lookupcategory_idx` (`updated_by`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lookup_category`
--

LOCK TABLES `lookup_category` WRITE;
