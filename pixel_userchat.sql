...
CREATE TABLE `userchat` (
  `userchatID` bigint NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`userchatID`),
  KEY `addedBy_userChat_idx` (`addedBy`),
  KEY `userID_userChat_idx` (`userID`),
  KEY `chatID_userChat_idx` (`chatID`),
  KEY `removedBy_userChat_idx` (`removedBy`)
